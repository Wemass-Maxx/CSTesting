...
lib.ssMetadata = [
		{name:"1200_atlas_1", frames: [[0,0,1920,1000],[0,1002,1920,1000]]},
		{name:"1200_atlas_2", frames: [[0,0,1282,541]]}
];
...
(lib.CachedBmp_1 = function() {
	this.initialize(ss["1200_atlas_2"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();



(lib._1000ref = function() {
	this.initialize(ss["1200_atlas_1"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();



(lib._1200ref = function() {
	this.initialize(ss["1200_atlas_1"]);
	this.gotoAndStop(1);
}).prototype = p = new cjs.Sprite();
// helper functions:
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(1675.4,408,1,1,0,0,0,42.5,56.6);
	...
	// ref
	this.instance_2 = new lib._1200ref();

	this.instance_3 = new lib._1000ref();

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_3},{t:this.instance_2}]}).to({state:[{t:this.instance_3},{t:this.instance_2}]},89).wait(1));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(960,483.7,960,516.3);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/1200_atlas_1.png", id:"1200_atlas_1"},
		{src:"images/1200_atlas_2.png", id:"1200_atlas_2"}
	],
	preloads: []
};
